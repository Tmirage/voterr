...
export default function HostPicker({ members, currentHostId, onSelect, onClose }: Props) {
  useEffect(() => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className="bg-gray-800 rounded-xl p-6 w-full max-w-md">
        ...
        <p className="text-sm text-gray-400 mb-4">Select a group member to be the host</p>
