...
export default function MovieNightCountdown({
  title,
  date,
  time,
  hostName,
  ...
  return (
    <div>
      ...
      {groupName && <p className="text-gray-400 mt-1">{groupName}</p>}

      {groupDescription && <p className="text-sm text-gray-500 mt-1">{groupDescription}</p>}
