    ...
    <div className="max-w-4xl mx-auto space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-400 text-sm">{stats?.total || 0} total entries</p>
        </div>
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={clsx(
                      'text-sm capitalize',
                      filter.level === level ? config.color : 'text-gray-300'
                    )}
                  >
                    {level}
                  </span>
                ...
                <p
                  className={clsx(
                    'text-xl mt-1',
                    filter.level === level ? config.color : 'text-white'
                  )}
                >
                  {count}
                </p>
